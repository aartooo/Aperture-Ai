...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    contentBlocks: Schema.Attribute.DynamicZone<
      ['article-images.image-block', 'article-images.video-embed-block']
    >;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    reviewDetails: Schema.Attribute.Component<'shared.review-details', false>;
...
export interface ApiAuthorProfileAuthorProfile
  ...
  attributes: {
    ...
    authorProfile: Schema.Attribute.Relation<'oneToOne', 'admin::user'>;
